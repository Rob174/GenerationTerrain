...
class FolderInfos:
    ...
    root_folder = None
    """str, path to the GenerationTerrain folder"""
    id = None
    ...
    def init(custom_name="",subdir="",test_without_data=False,with_id=None):
        ...
        while True:
            ...
            FolderInfos.data_raw = FolderInfos.separator.join(
                os.path.realpath(__file__).split(FolderInfos.separator)[:-2] + ["data_raw"]) + FolderInfos.separator
            try:
